...
ice_cream = {'choclate', 'vanilla', 'strawberry', 'neopolitan',
             'choclate chip', 'rocky road', 'cookie dough'}
...
# remove will genereate an error if the item does not exist
...
# discard will be removed without generating an error
